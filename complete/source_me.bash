...
alias container-run='docker run -p 8080:8080 robatdocker/myapp'
alias container-shell='docker run -ti --entrypoint /bin/sh robatdocker/myapp'
alias gradle-app='./gradlew bootRun'
alias gradle-bom='./gradlew cyclonedxBom'
alias gradle-jar='./gradlew build'
alias image-build='docker build -t robatdocker/myapp .'
